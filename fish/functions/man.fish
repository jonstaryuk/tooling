function man --description 'Format and display manual pages'
    ...
    set -q man_standout; and set -l standout (set_color $man_standout); or set -l standout (set_color yellow)
    set -q man_underline; and set -l underline (set_color $man_underline); or set -l underline (set_color green)
